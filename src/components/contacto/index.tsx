    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row gap-8 pb-8 md:pb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-center items-center w-full md:w-1/2 mx-auto">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p>Links Redes</p>
                        <p>Hablá más fuerte que tengo una toalla, o mejor hacé click para escribirme</p>
                    </div>
                </div>
